...
export const exampleCases: ExampleCase[] = [
  {
    project: {
      ...
      existingArtifact: "产品概念和试衣流程草图",
      hasDemo: false,
      hasPublished: false,
      iterationCount: 1,
      contactedUserCount: 3,
      hasQuoted: false,
    },
    evidence: {
  ...
  },
  {
    project: {
      ...
      existingArtifact: "可直接试玩的网页演示版",
      hasDemo: true,
      hasPublished: true,
      iterationCount: 4,
      contactedUserCount: 18,
      hasQuoted: false,
    },
    evidence: {
      competitorResearch: true,
